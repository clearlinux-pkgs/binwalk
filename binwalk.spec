...
Version  : 2.3.2
Release  : 18
URL      : https://github.com/ReFirmLabs/binwalk/archive/v2.3.2/binwalk-2.3.2.tar.gz
Source0  : https://github.com/ReFirmLabs/binwalk/archive/v2.3.2/binwalk-2.3.2.tar.gz
...
%prep
%setup -q -n binwalk-2.3.2
cd %{_builddir}/binwalk-2.3.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1629135611
...
cp %{_builddir}/binwalk-2.3.2/LICENSE %{buildroot}/usr/share/package-licenses/binwalk/ef53b2a881493ff495032066771aed6ceae431b8
